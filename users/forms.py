...
class NewUserForm(UserCreationForm):
    ...
    username = forms.CharField(required=True , widget=forms.TextInput(attrs={'class':'focus:outline-none','placeholder':'Sandip'}))
    ...
    def save(self,commit=True):
        ...
        self.cleaned_data = self.cleaned_data['email']
        if commit:
            user.save()
        return user